...
public class ProdutoController {
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<ProdutoDto> atualizandoValorDoProduto(@PathVariable String id, @Valid @PathVariable String valor){
       
        double valorAtual = Double.parseDouble(valor);
        ProdutoDto produtoAtualizado = servicoProduto.atualizandoValorDoProduto(id, valorAtual);
